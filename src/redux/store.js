...
const shippingAddressFromStorage = localStorage.getItem(PRO_SHOP_SHIPPING_ADDRESS_KEY) ? JSON.parse(localStorage.getItem(PRO_SHOP_SHIPPING_ADDRESS_KEY)) : null;
